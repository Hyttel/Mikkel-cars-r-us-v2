...
public class ReservationService {
    ...
    public void reserveCar(String username, int carId, LocalDate date) {
        ...
        if (reservationRepository.existsByCar_IdAAndAndRentalDate(carId,date)) {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Car reserved fort his date");
        }
